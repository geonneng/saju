...
위 정보를 가진 사람의 다음 세 가지 운세를 각각 자세하게 분석해줘:
1. 오늘의 운세 (250-300자): 전반적인 오늘의 흐름, 주의할 점, 길한 방향과 시간대, 추천 행동
2. 재물운 (250-300자): 재물운의 흐름, 투자와 지출에 대한 조언, 금전적 기회, 주의사항
3. 애정운 (250-300자): 애정운의 전반적 흐름, 관계 개선 방법, 새로운 만남의 가능성, 조언

구체적이고 실용적인 조언을 포함하여 현대적이고 희망적인 어조로 설명해줘. 반드시 아래 JSON 형식으로만 응답해줘:
